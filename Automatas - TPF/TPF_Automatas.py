...
def get_users():
    ...
    # Lo meto en un txt
    with open('1 - usuarios.txt', 'w') as f:
...
def get_MAC_AP():
    ...
    # Lo meto en un txt
    with open('2 - MAC_AP.txt', 'w') as f:
        for mac_ap in lista_MAC_AP:
            f.write(f'{mac_ap}\n')
...
def get_mac_Cliente():
    ...
    for element in lista_MAC_Cliente:
        if type(element) == int or type(element) == float:
            if math.isnan(element):
                lista_MAC_Cliente.remove(element)

    # Lo meto en un txt
    with open('3 - MAC_CLI.txt', 'w') as f:
        for mac_cli in lista_MAC_Cliente:
            f.write(f'{mac_cli}\n')
...
def get_trafico():
    ...
    #fecha_1 = input('Ingrese desde cuando desea tomar la fecha\nEj: 28 08 2019\n> ')
    #fecha_2 = input('Ingrese hasta cuando desea tomar la fecha\nEj: 28 08 2019\n> ')
